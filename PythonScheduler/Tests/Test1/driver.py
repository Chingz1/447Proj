...
try:
	dataClasses = pd.read_excel(r'ClassRoomTest1.xlsx', sheet_name='Schedule')  # reading file
except Exception:
	print("Error: There is no table in your classroom file titled 'Schedule'.")
try:
	dataRooms = pd.read_excel(r'ClassRoomTest1.xlsx', sheet_name='Capacity')  # reading file
except Exception:
	print("Error: There is no table in your classroom file titled 'Capacity'.")
try:
	dataBuild = pd.read_excel(r'ClassRoomTest1.xlsx', sheet_name='Coords')  # reading file
except Exception:
