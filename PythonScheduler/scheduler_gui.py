...
if __name__ == "__main__":
    ...
    button1 = tk.Button(entry, text="Go", command=lambda:go(entry,inputFile,outputFile),bg='black',fg="white") #keep going button
    button1.config(highlightthickness=0)
    button2 = tk.Button(entry, text="Quit", command=lambda:quit_top(entry,root),bg='black',fg='white') #quit button
